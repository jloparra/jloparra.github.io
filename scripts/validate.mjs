...
const required=['index.html','src/app.mjs','src/decision-engine.mjs','styles.css','legal/aviso-legal.html','legal/privacidad.html','legal/cookies.html','legal/accesibilidad.html','legal/terminos-demo.html'];
